...
(function () {
    ...
    (function () {
        ...
        c.dom.getPosition = function (f) {
            f = c.dom.g(f);
            var o = c.dom.getDocument(f), i = c.browser, l = c.dom.getStyle,
                h = i.isGecko > 0 && o.getBoxObjectFor && l(f, "position") == "absolute" && (f.style.top === "" || f.style.left === ""),
                m = {left: 0, top: 0}, k = (i.ie && !i.isStrict) ? o.body : o.documentElement, p, g;
            if (f == k) {
                return m
            }
            if (f.getBoundingClientRect) {
                ...
                var n = o.body, q = parseInt(l(n, "borderLeftWidth")), j = parseInt(l(n, "borderTopWidth"));
                if (i.ie && !i.isStrict) {
                    m.left -= isNaN(q) ? 2 : q;
                    m.top -= isNaN(j) ? 2 : j
                }
        ...
        c.event.on = function (g, j, l) {
            ...
            var k = function (n) {
                l.call(g, n)
            }, f = c.event._listeners, i = c.event._eventFilter, m, h = j;
            j = j.toLowerCase();
            if (i && i[j]) {
                m = i[j](g, j, k);
                h = m.type;
        ...
        c.lang.Class.prototype.dispatchEvent = function (j, f) {
            ...
            var h, g = this.__listeners, k = j.type;
        ...
        c.lang.inherits = function (l, j, i) {
            var h, k, f = l.prototype, g = new Function();
    ...
    e.prototype._setupDefaultStyles = function () {
        ...
        for (var g = 0, f; f = h[g]; g++) {
            this._styles.push({url: b + g + "." + a, size: new BMap.Size(f, f)})
        }
    };
